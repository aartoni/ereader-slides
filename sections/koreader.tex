...
\begin{frame}{KOReader}
    KOReader~\cite{koreader:web} is an app that allows you to read e-books in many formats (e.g., epub, PDF) on Unix-like OSs (e.g., Debian, Nickel).
...
\begin{frame}{E-ink Quirks}
    E-ink devices are extremely slow at refreshing and suffer from ghosting.
